...
-- GLOBALS: AceKGUIEditBoxInsertLink, ChatFontNormal, OKAY

--[[-----------------------------------------------------------------------------
Support functions
-------------------------------------------------------------------------------]]
if not AceKGUIEditBoxInsertLink then
	-- upgradeable hook
	hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceKGUIEditBoxInsertLink(...) end)
end

function _G.AceKGUIEditBoxInsertLink(text)
	for i = 1, AceKGUI:GetWidgetCount(Type) do
		local editbox = _G["AceKGUI-3.0EditBox"..i]
