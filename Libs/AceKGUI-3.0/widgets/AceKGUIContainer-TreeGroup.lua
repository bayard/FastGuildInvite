...
local methods = {
	...
	["CreateButton"] = function(self)
		local num = AceKGUI:GetNextWidgetNum("TreeGroupButton")
		local button = CreateFrame("Button", ("AceKGUI30TreeButton%d"):format(num), self.treeframe, "OptionsListButtonTemplate")
		button.obj = self
