...
frame:SetTooltip(L.tooltip["Не отображать в чате сообщения аддона"])
fontSize(frame.text)
...
frame:SetTooltip(L.tooltip["Не отображать в чате системные сообщения"])
fontSize(frame.text)
frame.frame:HookScript("OnClick", function()
...
frame:SetTooltip(L.tooltip["Не отображать в чате отправляемые сообщения"])
fontSize(frame.text)
frame.frame:HookScript("OnClick", function()
...
frame:SetHeight(40)
frame:SetCallback("OnClick", function() interface.filtersFrame:Show();settingsFrame:Hide() end)
...
frame:SetText(L["Настроить сообщения"])
fontSize(frame.text)
